 ...
 * @endcode
 */
$settings['hash_salt'] = 'QUXTV-GUlAeX7LHyxNhSaNJNHUfAh35niyHgEsEyY86ut65avGELesKVAERw9SKF64_5E1yRGg';
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/hirocfree/hirocfree-settings.inc';
}

/**
 * Add password protection to dev and staging on Acquia.
 *
 * @see https://library.acquia.com/articles/password-protect-your-non-production-environments-acquia-hosting
 */
// Make sure drush keeps working. Modified from function drush_verify_cli().
if (!(php_sapi_name() == 'cli') && (isset($_ENV['AH_NON_PRODUCTION']) && $_ENV['AH_NON_PRODUCTION'])) {
  $username = 'hiroc';
  $password = 'apple';
...
if (file_exists($app_root . '/' . $site_path . '/config.settings.php')) {
  include $app_root . '/' . $site_path . '/config.settings.php';
}
...
$settings['install_profile'] = 'hiroc';
$databases['default']['default'] = array (
  'database' => 'fatality',
  'username' => 'hiroc',
  'password' => 'apple',
